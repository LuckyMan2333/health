...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "JZQBZG1BuqFg87MIkCZR7M0d4eNgvLDIvJ77RwLe";//七牛云密钥账号
    private static final String SECRETKEY = "sBYrW57zn-1xbqBz9eKuJcY8tU-MV9qnLDEYSCU5";//七牛云密钥密码
    private static final String BUCKET = "blackhorse102";//七牛云的仓库名
    public static final String DOMAIN= "http://qiqnq0yy0.hn-bkt.clouddn.com/";//仓库的地址

    public static void main(String[] args) {
        //uploadFile("C:\\Users\\Eric\\Desktop\\file\\timg.jpg","dd2.jpg");
        //uploadFile("D:\\imp\\atm.jpg","atm.jpg"); 上传图片
        //removeFiles("atm.jpg");       删除图片
        //listFile();       查看所有图片
    }
