...
public class SMSUtils {
	public static final String VALIDATE_CODE = "SMS_205129407";//发送短信验证码模板编码  模版CODE
	public static final String ORDER_NOTICE = "SMS_159771588";//体检预约成功通知
	//private static final String SIGN_NAEM = "黑马程序员";// 短信的签名
	private static final String SIGN_NAEM = "IT黑马";// 短信的签名
	private static final String PARAMETER_NAME="code";
	private static final String ACCESS_KEY="LTAI4GKbk9zXiS84ahUa56ST"; //你的AccessKey ID
	private static final String SECRET_KEY="BFCtl07fxbTeP5FTJNqm2qiDzq8rDu"; //你的AccessKey Secret

	public static void main(String[] args) throws ClientException {
		SMSUtils.sendShortMessage(VALIDATE_CODE,"15303940903","55555");
	}
